...
export const featureFlags: FeatureFlags = {
  ...
  inferenceModelOverride: env.DEMO_MODE ? env.INFERENCE_MODEL_OVERRIDE ?? null : null,
  fetchTimeoutMsOverride: env.DEMO_MODE ? env.FETCH_TIMEOUT_MS ?? null : null,
  maxFetchSizeMbOverride: env.DEMO_MODE ? env.MAX_FETCH_SIZE_MB ?? null : null,
  maxOutputTokensOverride: env.DEMO_MODE ? env.MAX_OUTPUT_TOKENS ?? null : null,
};
